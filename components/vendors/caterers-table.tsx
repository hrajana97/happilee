...
export const columns: ColumnDef<Caterer>[] = [
  {
    accessorKey: "name",
    header: "Name",
    cell: ({ row }) => (
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem
              onClick={() => navigator.clipboard.writeText(caterer.id)}
            >
              Copy caterer ID
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem>
              <Link href={`/dashboard/vendors/compare?vendor=${caterer.id}`}>
                Compare
              </Link>
            </DropdownMenuItem>
